...
from .verify_claims.schemas import get_schemas as _get_verify_claims_schemas
from .verify_claims.tool import build_registry as _build_verify_claims_registry
...
def get_task_schemas() -> List[Dict[str, Any]]:
    ...
    return [
        *_get_email_search_schemas(),
        *_get_kg_query_schemas(),
        *_get_verify_claims_schemas(),
    ]
...
def get_task_registry(agent_name: str) -> Dict[str, Callable[..., Any]]:
    ...
    registry.update(_build_verify_claims_registry(agent_name))
    return registry
